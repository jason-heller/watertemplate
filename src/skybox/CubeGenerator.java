...
class CubeGenerator {
	...
	private static final int[] INDICES = { 0, 1, 3, 1, 2, 3, 1, 5, 2, 2, 5, 6, 4, 7, 5, 5, 7, 6, 0, 3, 4, 4, 3, 7, 7, 3,
			6, 6, 3, 2, 4, 5, 0, 0, 5, 1 };

	/**
	 * Generates a VAO containing the vertex positions of a box, to be used as a
	 * skybox.
	 * 
